            ...
            <div class="forge-compendium-alert flexrow">
                ...
                <div class="flexcol">
                    ...
                    <p class="notes flexcontain">
                        This is your library of compendium books.  If you have no books listed, please use the <a href="https://forge-vtt.com/bazaar#filter=all&type=dndbeyond" target="_blank">D&amp;D Beyond importer</a> from the Bazaar to import your books.
                    </p>
                </div>
            </div>
